(function() {
    ...
    function Module(element, options) {
        /* menu,body padding */
        let html_margin = (jQuery("#wpadminbar")).length > 0 ? jQuery("html").css('margin-top') : 0;
        let body_margin = jQuery('body').css('margin-top');
        // this.hasmenu            = (jQuery("#wpadminbar").length > 0?150:120);
        this.hasmenu = parseInt(html_margin) + parseInt(body_margin);        
    ...
    Module.prototype.handleMove = function(e) {
        ...
        for (var i = 0; i < dist; i++) {
            ...
            y = this.lastPoint.y + (Math.cos(angle) * i) - this.hasmenu;  
